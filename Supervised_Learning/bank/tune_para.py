...
train_entire_dataset = BankDataset(contents, split='train')
...
for fold in range(10):
    ...
    train_dataset = BankDataset(contents, split='train', is_entire=False, fold=fold)
    val_dataset = BankDataset(contents, split='train', is_entire=False, fold=fold, val=True)
