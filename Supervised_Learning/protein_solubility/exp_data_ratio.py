...
for fold in range(10):
    ...
    train_dataset = BioDataset(opt.csv_file, split='train', is_entire=False, fold=fold, percentage=opt.percentage)
    val_dataset = BioDataset(opt.csv_file, split='train', is_entire=False, fold=fold, val=True, percentage=opt.percentage)
